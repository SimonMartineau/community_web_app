        ...
        <div class="info_container">
            <p class="widget_info">
                <span class="info_line">
                    <span class="info_label">Points:</span>
                    <span class="info_value"><?php echo $volunteer_data_row['points'] ?> Points</span>
                </span>
                <span class="info_line">
                    <span class="info_label">Hours Completed:</span>
                    <span class="info_value"><?php echo $volunteer_data_row['hours_completed'] ?>/<?php echo $volunteer_data_row['hours_required'] ?> Hours</span>
                </span>
            </p>
        </div>
