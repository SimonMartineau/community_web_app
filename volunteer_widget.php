<a href="volunteer_profile.php?id=<?php echo $volunteer_data_row['id']; ?>" style="text-decoration: none;">
    <div id="volunteer_widget">
        <h3 class="volunteer_widget_name"><?php echo $volunteer_data_row['first_name'] . " " . $volunteer_data_row['last_name'] ?></h3>
        <p class="volunteer_widget_info">
