            ...
            <div id="major_rectangle">
                ...
                <div id="input_section">
                    ...
                    <form method="post" action="signup.php">
                        ...
                        <!-- Issuance date input -->
                        Issuance date: <input type="date" name="issuance_date"><br><br>

                        <!-- Validity date input -->
                        Validity date: <input type="date" name="validity_date"><br><br>

                        <!-- Points text input -->
                        <input name="address" type="text" id="text_input" placeholder="Number of points"><br><br>
